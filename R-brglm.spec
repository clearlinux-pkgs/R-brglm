...
%setup -q -n brglm
pushd ..
cp -a brglm buildavx2
popd
pushd ..
cp -a brglm buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737136165
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/brglm/libs/brglm.so
/V4/usr/lib64/R/library/brglm/libs/brglm.so
